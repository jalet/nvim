...
vim.g.netrw_banner = 0 -- use `I` to toggle
...
require('lazy').setup({
  ...
  { -- Autocompletion
    ...
    dependencies = {
      ...
      'hrsh7th/cmp-path',
      'hrsh7th/cmp-buffer',
      -- TODO: Move to command line setup 'hrsh7th/cmp-cmdline', https://github.com/hrsh7th/cmp-cmdline?tab=readme-ov-file#setup
      'neovim/nvim-lspconfig',
      'hrsh7th/cmp-calc',
    },
    config = function()
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = { 'bash', 'c', 'html', 'lua', 'luadoc', 'markdown', 'vim', 'vimdoc', 'terraform', 'go', 'java', 'javascript', 'rust', 'nix' },
